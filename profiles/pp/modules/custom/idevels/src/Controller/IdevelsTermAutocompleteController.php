...
/**
 * @file
 * Contains \Drupal\idevels\Controller\IdevelsTermAutocompleteController.
 */

namespace Drupal\idevels\Controller;
 ...
 */
class IdevelsTermAutocompleteController implements ContainerInjectionInterface {
